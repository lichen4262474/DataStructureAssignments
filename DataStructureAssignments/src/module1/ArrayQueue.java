...
public class ArrayQueue<T> {
	 ...
	 * double the current length. When resizing, copy elements to the beginning of
	 * the new array and reset front to 0.
	 *
	...
	public void enqueue(T data) {
		...
		if (size < backingArray.length) {
			...
			front = 0;
		} // close else (array is full need to resize)
		size++;
	}
